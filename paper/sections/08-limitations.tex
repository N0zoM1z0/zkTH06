...
\begin{itemize}
  ...
  probe now agrees with the Linux reference for 2,000 frames and a 47-field
  ...
  bullet motion, ANM reclamation, or collision.  It does not cover ranks 4--5,
  ...
  data, so it proves local allocation/geometry but does not close a persistent
  bullet-state witness boundary.
