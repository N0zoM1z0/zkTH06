...
\begin{itemize}
  ...
  \item \textbf{Backend statement remains a slice.}  SHA-256 binds the exact
  private workload and guest-computed endpoint, and the proof's public bytes
  have been decoded and checked.  However, all eleven movement-environment
  words are witness data rather than outputs of an enclosing TH06 transition.
