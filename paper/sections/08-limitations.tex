...
\begin{itemize}
  ...
  semantic projection on one replay.  Collided-bullet draw-only sprite z is an
  explicit projection exclusion justified by overwrite-before-read, not raw
  equality.  The probe does not yet export the eleven canonical
  ...
  reclamation, and score/power/subrank feedback through frame 249.  It does not
  cover ranks 4--5, the other shot routes,
  laser paths, enemy bullets, later ECL paths, or Player death.  Its dyadic rounding
  ...
  directly or prove RNG/effect and omitted-shooting noninterference,
  transcendental refinement, or complete writer correspondence.  The second
  Enemy wave, its RNG/ECL state, and Enemy bullets remain outside the guest.
