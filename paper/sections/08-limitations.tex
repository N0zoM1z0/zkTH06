...
\begin{itemize}
  ...
  probe now agrees with the Linux reference for 2,000 frames and a 46-field
  ...
  and it does not model hitbox/orb/animation side effects.  Shooting stops at
  \code{SpawnBullets} dispatch and does not model bullet slots, character/shot
  geometry, power-dependent patterns, or bullet collision.  Its dyadic rounding
