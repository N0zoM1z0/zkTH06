...
\begin{itemize}
  ...
  agrees with hardware result bits for the tested basic-operation cases, but
  it is neither formally verified nor complete x87 state semantics.  The
  address-indexed exact baseline, code binding, and any fixed-point refinement
  have not yet been implemented or proved.
