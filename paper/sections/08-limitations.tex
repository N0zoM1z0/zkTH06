...
\begin{itemize}
  ...
  a reachable finite bounded player-box invariant, collision-code binding,
  architectural masked-invalid/helper-path refinement, and caller binding,
  together with reachable difficulty and pre-score bounds.  The total Lean
  model covers finite, infinite, and NaN item coordinates conditionally; 2,081
  Linux samples exercise only its finite branch and prove none of those
  bindings.  The complete address-indexed semantics, code
