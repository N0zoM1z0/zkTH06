...
\begin{itemize}
  ...
  a reachable finite/non-NaN position invariant, collision-code binding, and
  helper-range refinement, together with reachable difficulty and pre-score
  bounds.  A conditional Lean model and 2,081 Linux samples
  support the proposed $[-4,452]$ collected-item interval but prove none of
  those premises.  The complete address-indexed semantics, code
