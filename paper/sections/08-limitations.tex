...
\begin{itemize}
  ...
  every active bullet and Enemy projection.  It deliberately omits the
  death-spawned Item state and therefore cannot cross its first score/power
  feedback at frame 249.  It does not cover ranks 4--5, the other shot routes,
  ...
  ECL-time-indexed x87 result table; the first-wave successor adds finite
  collision-ANM behavior but does not decode that script directly or prove
  RNG/effect/item and omitted-shooting noninterference, transcendental
  refinement, or complete writer correspondence.
