...
\begin{itemize}
  ...
  store, rounding, and integer-conversion cases, but it is neither formally
  verified nor complete x87 state semantics.  Condition codes, load exceptions,
  complete helper ABIs, address binding, and transcendental behavior remain
  open.  The address-indexed exact baseline, code binding, and any fixed-point
