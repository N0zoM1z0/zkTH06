...
reference and a portable implementation.  A proof-oriented slice is frozen
only after its own retail boundary agrees; a complete gameplay guest still
requires representative full-replay and projection gates.  This permits early
backend cost experiments without promoting a finite slice to whole-game
equivalence.
