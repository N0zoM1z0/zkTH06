...
in Lean, but startup state and transcendental microarchitecture are not yet
proved.  The fidelity design therefore binds operations to original addresses
and store widths instead of assuming source-level host arithmetic is exact.
