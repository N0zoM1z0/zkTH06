...
remains counterexample search: startup state, load/remainder behavior,
reachable helper ranges, address binding, and transcendental microarchitecture
are not yet proved.  The fidelity design therefore binds operations to original
addresses and store widths instead of assuming source-level host arithmetic is
exact.
