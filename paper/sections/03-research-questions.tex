...
\code{SpawnBullets} request schedule.  A fourth proves a batch of local
Reimu-A ranks 1--3 allocation/geometry calls from independently retail-bound
pre-states.  A fifth removes those slot-state witnesses for 206 linked
rank-1 transitions and fails closed before the first Enemy collision.  The
enclosing guests commit only fixed configuration,
