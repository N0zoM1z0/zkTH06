...
the shipped executable and Linux reference for 2,000 frames on a 40-field raw
...
Its tracked application proof binds the exact guest executable, executes
5,412,644 instructions at an estimated 209,865,030 cells, proves in 73.18
seconds with approximately 47.1 GiB peak resident memory, and verifies in 0.11
seconds.  A
