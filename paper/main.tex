...
1,000,014 in-domain EDX:EAX results match exact dyadic truncation.  These
two audited families are materialized as a hash-bound, byte-free ledger of 321
original addresses, each still marked with open slicing and refinement status.
