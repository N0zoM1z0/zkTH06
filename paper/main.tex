...
results establish same-host self-consistency and an arithmetic proof surface
only; exact x87 transcendental semantics, presentation-dependent state, and an
