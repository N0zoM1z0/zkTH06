...
proof rather than an enclosing bullet-subsystem proof.  A fifth guest closes
that witness boundary through frame 207.  A sixth composes the first five
Stage-1 enemies and crosses the first real collision at frame 208 using 438
bytes of replay-only private input.  It derives 200 damage calls, the unique
slot-2 collision, first-enemy death, target selection, and score 390 in
19,787,280 instructions and 769,444,525 cells; its tracked application proof
completes in 203.58 seconds and verifies in 0.22 seconds.  A
...
transition profile through one Enemy death, and arithmetic proof surface only;
the fixed post-calc anchor, Player death/respawn, bombs, time-stop writers, exact x87
