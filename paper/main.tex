...
the shipped executable and Linux reference for 2,000 frames on a 23-field raw
projection, while observing ambient x87 control word \code{0x007f} at every
post-calc anchor.  A hash-bound static audit attributes 5,980 x87
...
These results establish a first narrow retail anchor and an arithmetic proof
