...
modeled helper invalid path to low EAX zero.  A sealed Linux probe observes
2,081 collected items without a range violation, but does not promote that
corpus result into a proof.
