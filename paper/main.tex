...
conditional Lean model isolate a finite/non-NaN item-position invariant; a
sealed Linux probe observes 2,081 collected items without a range violation,
but does not promote that corpus result into a proof.
