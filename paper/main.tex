...
the shipped executable and Linux reference for 2,000 frames on a 34-field raw
...
floating point; it matches 1,999 consecutive retail-derived transitions.  The
same crate now runs in an OpenVM v2.0.1 RV32IM guest whose public value is a
full SHA-256 commitment to the private workload and computed endpoint.  Its
tracked application proof binds the exact guest executable, executes 6,205,625
instructions at an estimated 254,156,116 cells, proves in 75.65 seconds with
approximately 48.0 GiB peak resident memory, and verifies in 0.12 seconds.  A
...
These results establish a first narrow retail anchor, executable sliced
transition, and arithmetic proof surface only; exact x87
